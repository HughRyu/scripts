...
curl -x http://192.168.199.5:1999 -fsSL https://hughr.de/ssh-onekey | bash
curl -x http://192.168.199.5:1999 -fsSL https://hughr.de/ssh-onekey | bash -s -- -m
#for offline Manual mod
